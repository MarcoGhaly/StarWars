...
function updateEnemyMove() {
    ...
    if (parseInt(enemyShip.style.left) >= toPos_x - 50 && parseInt(enemyShip.style.left) <= toPos_x + 50
        && parseInt(enemyShip.style.top) >= toPos_y - 50 && parseInt(enemyShip.style.top) <= toPos_y + 50) {
        ...
        while(true){
            ...
            toPos_x = parseInt(Math.random() * 700) + 50;
            if(Math.abs(toPos_x - parseInt(enemyShip.style.left))>200)
                break;
        }
    ...
    if (enemy_Direction === "right") {
        ...
        spaceShip_x = parseInt(enemyShip.style.left) + enemy_moveUnit;
        spaceShip_y = parseInt(enemyShip.style.top);
